...
import os
from predictable.probes.mlp.mlp import MLPProbe, parse_hidden_dims
...
def find_best_probe() -> Path:
    ...
    probe_files = list(PROBE_DIR.glob("mlp_*.pt"))
    ...
    for probe_file in probe_files:
        # Parse R² from filename: mlp_log_h512_d0.1_e50_bs64_lr0.001_spear0.900_r20.79.pt
        try:
